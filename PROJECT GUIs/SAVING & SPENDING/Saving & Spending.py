...
class Saving_Spending:
    def __init__(self):
        ...
        # PhotoImage Objects
        self.edit_image_obj = PhotoImage(file=self.resource_path('name.png'))
        self.name_image_obj = PhotoImage(file=self.resource_path('edit.png'))
        ...
        self.rupees_image_obj = PhotoImage(file=self.resource_path('earning.png'))
        self.earning_image_obj = PhotoImage(file=self.resource_path('rupees.png'))
        ...
        self.earned_button = Button(self.earned_button_frame, bg='#01912f', activebackground='#01912f', text='MY EARNING', **self.home_button_attributes, command=lambda title='Earned details', text='MY\n EARNING', image=self.save_image_obj, file_name=self.saving_file, yet='Not Earned Yet': self.show_details_window(title, text, image, file_name, yet))
        ...
        self.spent_button = Button(self.spent_button_frame, bg='RED', activebackground='RED', text='MY SPENDING', **self.home_button_attributes, command=lambda title='Spent details', text='MY\n SPENDING', image=self.spent_image_obj, file_name=self.spent_file, yet='Not Spent Yet': self.show_details_window(title, text, image, file_name, yet))
